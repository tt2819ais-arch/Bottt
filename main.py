...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /start от {update.effective_user.username}")
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /help от {update.effective_user.username}")
...
async def drop_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /drop от {update.effective_user.username}")
...
async def ask_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /ask от {update.effective_user.username}")
...
async def rub_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /rub от {update.effective_user.username}")
...
async def add_admin_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /add_admin от {update.effective_user.username}")
...
async def remove_admin_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /remove_admin от {update.effective_user.username}")
...
async def stats_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /stats от {update.effective_user.username}")
...
async def reset_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /reset от {update.effective_user.username}")
...
async def reset_drops_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /reset_drops от {update.effective_user.username}")
...
async def remove_drop_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Вызвана команда /remove_drop от {update.effective_user.username}")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Сообщение от {user.username if user else 'Неизвестный'}: {message_text[:50]}")
    ...
    if message_text in ACTIVATION_KEYWORDS:
        ...
        for drop_username, drop_info in drops.items():
            if drop_info.get("status") == DropStatus.WELCOMED.value:
                ...
                instruction = f"""{drop_username} - Сейчас тебе будет приходить денюжка. Каждое поступление - мне скрин из истории операций. Не отдельного перевода, а прям страницу истории, списком.
Следи за этим, мне надо сразу сообщать (скидывать скрин), как прилетит денюжка.
...
def main():
    ...
    # Регистрация обработчиков команд в правильном порядке
    ...
    application.add_handler(CommandHandler("reset_drops", reset_drops_command))
    application.add_handler(CommandHandler("remove_drop", remove_drop_command))
    ...
    logger.info("Доступные команды: /start, /help, /drop, /ask, /rub, /stats, /reset, /add_admin, /remove_admin, /reset_drops, /remove_drop")
